          ...
          <div class="col d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Free Test Questions</h5>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Saya melakukan pekerjaan secara menyeluruh hingga selesai</h6>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Saya suka mencari-cari kesalahan orang lain</h6>
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Saya mudah berteman dengan siapapun</h6>
                            <span class="fw-normal">Project Manager</span>                          
                        </td>
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-1">Saya selalu memiliki ide-ide baru</h6>
